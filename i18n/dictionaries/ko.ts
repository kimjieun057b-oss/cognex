...
const ko: Dictionary = {
  ...
  successStories: {
    ariaLabel: "고객 성공 사례 섹션",
    eyebrow: "SUCCESS STORIES",
    title: "Cognex를 통해 성공을 거둔 고객 사례",
    viewAllLabel: "전체 보기",
    detailLabel: "자세히 보기",
    slideAria: (i, title) => `성공 사례 ${i + 1}: ${title}`,
    items: [
      {
        title: "Panpass Technology의 제품 수명 주기 관리를 디지털 방식으로 혁신",
        heading: "품질 향상을 넘어 브랜드 평판까지",
        body: "99.9%의 뛰어난 코드 판독 정확도로 품질과 효율성을 대폭 향상시키며, 공급망의 종합적인 추적 가능성과 투명성을 개선합니다. 이를 통해 브랜드를 철저히 보호하고 고객 충성도를 강화하여 기업의 평판을 지켜냅니다.",
      },
      {
        title: "슈나이더 일렉트릭이 Cognex OneVision으로 AI 검사를 표준화한 방법",
        heading: "검사 정확도를 넘어 통합 속도까지",
        body: "OneVision 기반 AI 검사 표준화로 거짓 거부 횟수를 70배 줄여 작업 효율을 높이고 불필요한 폐기물을 감소시켰습니다. 신규 검사 애플리케이션의 통합 시간은 30% 단축되었으며, 검사 커버리지를 확장해 감지 정확도를 대폭 향상시켰습니다.",
      },
      {
        title: "Federal Package, 결함 감지율 99% 이상 달성",
        heading: "전수 검사를 넘어 완벽한 품질 약속까지",
        body: "제품 검사율 100%의 전수 검사를 통해 결함 감지 정확도를 99% 이상으로 끌어올렸습니다. 이를 통해 탁월한 품질에 대한 고객과의 브랜드 약속을 완벽하게 이행하며 만족스러운 결과를 이끌어냈습니다.",
      },
      {
        title: "Wipro PARI가 AI를 이용해 EV 제조 문제를 해결하는 방법",
        heading: "검사 속도를 넘어 비용 효율까지",
        body: "수많은 구성 요소 구성을 고려하면서도 EV 배터리 모듈 검사 속도를 가속화했습니다. EtherInspect로 여러 가상 카메라를 구현해 비용 효율적인 솔루션을 배포했으며, 비전 가이드 로봇과 비전 소프트웨어, 바코드 스캐너를 결합해 처리량과 추적 가능성을 함께 향상시켰습니다.",
      },
    ],
  },
};
