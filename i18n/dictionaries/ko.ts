...
const ko: Dictionary = {
  ...
  solutions: {
    ...
    appContent: [
      { title: "어셈블리 검사 및 검증", body: "[더미] 첨단 머신 비전 기술로 복잡한 어셈블리 공정의 모든 구성 요소를 정밀하게 검사하고 검증하여 제품 품질과 생산 신뢰성을 보장합니다. 실제 콘텐츠는 추후 업데이트 예정입니다." },
      { title: "자동 결함 감지", body: "[더미] 첨단 머신 비전과 AI의 강력한 기능을 통해 모든 결함을 감지하여 일관된 품질을 보장하고 비용이 많이 드는 오류를 줄입니다. 실제 콘텐츠는 추후 업데이트 예정입니다." },
      { title: "바코드 스캐닝 및 추적", body: "[더미] 고속 바코드 판독 기술로 공급망 전반의 제품 추적성을 확보하고, 물류 효율과 데이터 정확성을 동시에 높입니다. 실제 콘텐츠는 추후 업데이트 예정입니다." },
      { title: "자동 분류 및 분류", body: "[더미] 정밀 비전 시스템을 통해 제품을 형태·색상·크기 기준으로 자동 분류하고 불량품을 신속하게 배출하여 생산 효율을 극대화합니다. 실제 콘텐츠는 추후 업데이트 예정입니다." },
      { title: "측정 및 치수 확인", body: "[더미] 비접촉식 정밀 측정 기술로 마이크로미터 단위의 치수 편차까지 실시간으로 검출하여 설계 규격 준수를 자동으로 보장합니다. 실제 콘텐츠는 추후 업데이트 예정입니다." },
      { title: "가이드 및 정렬", body: "[더미] 비전 기반 가이드 시스템이 로봇 암과 자동화 장비의 정확한 위치 정렬을 실시간으로 지원하여 조립 정밀도를 향상시킵니다. 실제 콘텐츠는 추후 업데이트 예정입니다." },
      { title: "광학 문자 인식 (OCR)", body: "[더미] 딥러닝 기반 OCR 엔진이 다양한 서체·방향·표면의 문자를 정확하게 판독하여 추적성 확보와 데이터 품질 향상에 기여합니다. 실제 콘텐츠는 추후 업데이트 예정입니다." },
    ],
    industryContent: [
      { title: "반도체", body: "[더미] 웨이퍼·패키지 검사부터 마킹 판독까지, 반도체 제조 전 공정에 걸쳐 수율을 높이고 불량을 최소화합니다." },
      { title: "식음료", body: "[더미] 라벨 검사, 이물질 감지, 용량 확인 등 식음료 라인의 품질 및 안전 기준을 자동으로 충족합니다." },
      { title: "자동차", body: "[더미] 차체·엔진·전장부품의 결함 감지와 조립 검증을 통해 자동차 제조 품질을 보장합니다." },
      { title: "제약", body: "[더미] 라벨·바코드·외관 검사로 의약품 규정 준수와 제품 추적성을 자동화합니다." },
      { title: "전자부품", body: "[더미] PCB·커넥터·소형 부품의 정밀 검사로 전자제품 생산 품질을 극대화합니다." },
      { title: "물류", body: "[더미] 물류 센터의 바코드 판독과 자동 분류로 처리 속도와 정확도를 동시에 높입니다." },
    ],
  },
